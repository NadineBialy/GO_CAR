...
public class MyLoc_to_Des extends FragmentActivity implements OnMapReadyCallback{
    ...
    private static boolean zoomOutFlag = false;
...
//                                Double userLongtitude = location.getLongitude();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zoomOutFlag = false;
        System.out.println(latitude+"EXTRACTED");
    ...
    private void getMyLocation(){
        ...
        System.out.println(currentApiVersion+"CURRENT");
        System.out.println( Build.VERSION_CODES.M +"BUILD VERSION");
             if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
                    android.Manifest.permission.ACCESS_FINE_LOCATION)
                    == PackageManager.PERMISSION_GRANTED)
                  {
...
//                    }
//                });
                      System.out.println(MainActivity.carLat+ ""+MainActivity.catLng+"LONGGG");
                        mDestination = new LatLng(Double.parseDouble(MainActivity.carLat), Double.parseDouble(MainActivity.catLng));
                        mMap.clear();
                        mMarkerOptions = new MarkerOptions().position(mDestination).title("Destination");
                        mMap.addMarker(mMarkerOptions);

                        System.out.println(mOrigin+"mORIGIN");
                        System.out.println(mDestination + "DESTINATION");
                        if(mOrigin == null || mDestination == null){
                            //System.out.println()
                            mOrigin = new LatLng(MainActivity.userLatitude, MainActivity.userLongtitude);
                        }
                        drawRoute();
    ...
    private String getDirectionsUrl(LatLng origin,LatLng dest){
        ...
        // Key
        String key = "key=" + "AIzaSyB6MbLAynALssLd8JTB-v2f-JYZyS6ahmc";
    ...
    private class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... url) {
            ...
            System.out.println(url[0] +"URL DOWNLOD");
